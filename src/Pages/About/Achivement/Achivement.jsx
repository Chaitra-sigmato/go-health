                ...
                <Row className="align-items-center">
                    <Col md={6} lg={6} sm={12}>
                        ...
                        <div className="achivement-txt">
                            <p className="w-75">Smiling comes naturally to Dr. Harrie, author of ‘HexaHealth’. He has embraced Cosmetic Dentistry and has redesigned the smiles for thev thousands of patients.</p>
